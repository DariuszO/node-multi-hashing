    ...
    "targets": [
        {
            ...
            "sources": [
                ...
                "src/cryptonight_dark.c",
                "src/cryptonight_dark_lite.c",
                "src/cryptonight_lite.c",
                "src/cryptonight_turtle.c",
                "src/cryptonight_turtle_lite.c",
                "src/cryptonight_soft_shell.c",
                "src/fresh.c",
                "src/fugue.c",
                "src/groestl.c",
                "src/hefty1.c",
